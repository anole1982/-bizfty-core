 ...
 */
package com.icss.regie.product.svc.war.soap;
...
import com.icss.regie.product.svc.api.gateways.ProductGateway;
...
@WebService(serviceName = "ProductGateway", portName = "ProductGatewayPort",
                    targetNamespace = "http://api.svc.product.regie.icss.com/gateways",
                    endpointInterface = "com.icss.regie.product.svc.api.gateways.ProductGateway")
